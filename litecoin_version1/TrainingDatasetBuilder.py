...
def getData(date):
    dataminer = DataMiner(date, 'litecoin', 'LTC')
    ...
    df = pd.DataFrame(data, columns=['Date', 'LTC_Price','Number_of_articles', 'news_sentiment', 'news_subjectivity', 'reddit_sentiment', 'reddit_subjectivity', 'google_trends'], dtype=str)
